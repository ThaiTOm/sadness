...
function ViewBlog() {
    ...
    return (
        <div className="viewBlog percent">
                            ...
                            <div className="viewBlog_li" key={i}>
                                <div className="contain_blog" >
                                    ...
                                    <div className="image-blog">
                                        {value && value.image.length > 0 && value.image[0].split(".")[1] === "jpeg" ? <ImageRender props={{ value, id }} /> : <VideoRender value={value.image} idBlog={value.idBlog} />}
